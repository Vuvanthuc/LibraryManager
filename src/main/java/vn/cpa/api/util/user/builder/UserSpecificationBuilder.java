package vn.cpa.api.util.user.builder;

import org.springframework.data.jpa.domain.Specification;
import org.springframework.stereotype.Component;
import vn.cpa.api.entity.Account;
import vn.cpa.api.util.user.filter.UsersGridFilter;
import vn.cpa.api.util.user.specification.SearchCriteria;
import vn.cpa.api.util.user.specification.UserSpecification;
